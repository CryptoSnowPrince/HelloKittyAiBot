...
async def handle_input(message: aiogram.types.Message):
    ...
    Twitter = "https://twitter.com/hellokitty_erc"
    Website = "https://HelloKittyETH.com"
    BuyLink = "https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=0x0D7b82Fb82C37Dfe2675022c73af85162E72c491"
    caption = f"{prompt}\nimage generated by @{origin_username}\n\n <a href ='{Website}'>Website</a> | <a href ='{Telegram}'>Telegram</a> | <a href ='{Twitter}'>Twitter</a> | <a href ='{BuyLink}'>Buy $KITTY</a>"
